...
BUILD		:=	build
SOURCES		:=	source source/Codecs source/Formats source/GME source/vgmstream source/vgmstream/meta source/vgmstream/layout source/vgmstream/coding
DATA		:=	data
ROMFS		:=	romfs
APP_TITLE	:=	VGMPlayerNX
APP_AUTHOR	:=	SimonTime
...
LIBS	:=	`aarch64-none-elf-pkg-config --libs SDL2 SDL2_ttf SDL2_mixer` -lstdc++fs
